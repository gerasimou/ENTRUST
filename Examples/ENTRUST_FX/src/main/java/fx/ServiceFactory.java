...
public class ServiceFactory {
	...
	private enum STUB{
		...
		MARKET_WATCH_4			("MW.MarketWatchService4Stub"),
		MARKET_WATCH_5 			("MW.MarketWatchService5Stub"),
		...
		TECHNICAL_ANALYSIS_5 	("TA.TechnicalAnalysisService5Stub"),
		...
		FUNDAMENTAL_ANALYSIS_4 	("FA.FundamentalAnalysisService4Stub"),
		FUNDAMENTAL_ANALYSIS_5 	("FA.FundamentalAnalysisService5Stub"),
		ORDER_1 				("OR.OrderService1Stub"),
		ORDER_2 				("OR.OrderService2Stub"),
		ORDER_3 				("OR.OrderService3Stub"),
		ORDER_4 				("OR.OrderService4Stub"),
		ORDER_5 				("OR.OrderService5Stub"),
		ALARM_1 				("AL.AlarmService1Stub"),
		ALARM_2 				("AL.AlarmService2Stub"),
		ALARM_3 				("AL.AlarmService3Stub"),
		ALARM_4 				("AL.AlarmService4Stub"),
		ALARM_5 				("AL.AlarmService5Stub"),
		...
		NOTIFICATION_4 			("NOT.NotificationService4Stub"),
		NOTIFICATION_5 			("NOT.NotificationService5Stub");
...
//			Class<?> cls = Class.forName("fx.services." + stub.getCode());
			...
			ServiceClient srvClient = new ServiceClient(id, reliability, costPerInvocation, timePerInvocation, 
														failureTimePattern, failureDegradationPattern, null);
