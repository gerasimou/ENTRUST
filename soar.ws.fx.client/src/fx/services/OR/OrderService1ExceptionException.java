...
public class OrderService1ExceptionException extends java.lang.Exception{
    ...
    private fx.services.OR.OrderService1Stub.OrderService1Exception faultMessage;
    ...
    public void setFaultMessage(fx.services.OR.OrderService1Stub.OrderService1Exception msg){
       faultMessage = msg;
    }
    
    public fx.services.OR.OrderService1Stub.OrderService1Exception getFaultMessage(){
       return faultMessage;
    }
}
