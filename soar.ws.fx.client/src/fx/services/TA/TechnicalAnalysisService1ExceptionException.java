...
public class TechnicalAnalysisService1ExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1436363064198L;
    
    private fx.services.TA.TechnicalAnalysisService1Stub.TechnicalAnalysisService1Exception faultMessage;
    ...
    public void setFaultMessage(fx.services.TA.TechnicalAnalysisService1Stub.TechnicalAnalysisService1Exception msg){
       faultMessage = msg;
    }
    
    public fx.services.TA.TechnicalAnalysisService1Stub.TechnicalAnalysisService1Exception getFaultMessage(){
       return faultMessage;
    }
}
