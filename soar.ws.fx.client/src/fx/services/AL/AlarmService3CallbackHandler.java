...
/**
 * AlarmService3CallbackHandler.java
 *
 ...
 */
    ...
    /**
     *  AlarmService3CallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class AlarmService3CallbackHandler{
    ...
    */
    public AlarmService3CallbackHandler(Object clientData){
    ...
    */
    public AlarmService3CallbackHandler(){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultgetNominalReliability(
                    fx.services.AL.AlarmService3Stub.GetNominalReliabilityResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultrun(
                    fx.services.AL.AlarmService3Stub.RunResponse result
                        ) {
           }
