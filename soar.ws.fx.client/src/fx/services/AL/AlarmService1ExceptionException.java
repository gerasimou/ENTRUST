...
public class AlarmService1ExceptionException extends java.lang.Exception{
    ...
    private fx.services.AL.AlarmService1Stub.AlarmService1Exception faultMessage;
    ...
    public void setFaultMessage(fx.services.AL.AlarmService1Stub.AlarmService1Exception msg){
       faultMessage = msg;
    }
    
    public fx.services.AL.AlarmService1Stub.AlarmService1Exception getFaultMessage(){
       return faultMessage;
    }
}
