...
public class AlarmService2ExceptionException extends java.lang.Exception{
    ...
    private fx.services.AL.AlarmService2Stub.AlarmService2Exception faultMessage;
    ...
    public void setFaultMessage(fx.services.AL.AlarmService2Stub.AlarmService2Exception msg){
       faultMessage = msg;
    }
    
    public fx.services.AL.AlarmService2Stub.AlarmService2Exception getFaultMessage(){
       return faultMessage;
    }
}
