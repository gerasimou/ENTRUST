...
public class MarketWatchService1ExceptionException extends java.lang.Exception{
    ...
    private fx.services.MW.MarketWatchService1Stub.MarketWatchService1Exception faultMessage;
    ...
    public void setFaultMessage(fx.services.MW.MarketWatchService1Stub.MarketWatchService1Exception msg){
       faultMessage = msg;
    }
    
    public fx.services.MW.MarketWatchService1Stub.MarketWatchService1Exception getFaultMessage(){
       return faultMessage;
    }
}
