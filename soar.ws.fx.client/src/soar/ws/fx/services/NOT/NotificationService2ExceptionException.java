...
public class NotificationService2ExceptionException extends java.lang.Exception{
    ...
    private soar.ws.fx.services.NOT.NotificationService2Stub.NotificationService2Exception faultMessage;
    ...
    public void setFaultMessage(soar.ws.fx.services.NOT.NotificationService2Stub.NotificationService2Exception msg){
       faultMessage = msg;
    }
    
    public soar.ws.fx.services.NOT.NotificationService2Stub.NotificationService2Exception getFaultMessage(){
       return faultMessage;
    }
}
