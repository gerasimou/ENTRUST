...
public class NotificationService1ExceptionException extends java.lang.Exception{
    ...
    private soar.ws.fx.services.NOT.NotificationService1Stub.NotificationService1Exception faultMessage;
    ...
    public void setFaultMessage(soar.ws.fx.services.NOT.NotificationService1Stub.NotificationService1Exception msg){
       faultMessage = msg;
    }
    
    public soar.ws.fx.services.NOT.NotificationService1Stub.NotificationService1Exception getFaultMessage(){
       return faultMessage;
    }
}
