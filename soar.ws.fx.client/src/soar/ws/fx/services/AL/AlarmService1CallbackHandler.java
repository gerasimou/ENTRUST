...
/**
 * AlarmService1CallbackHandler.java
 *
 ...
 */
    ...
    /**
     *  AlarmService1CallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class AlarmService1CallbackHandler{
    ...
    */
    public AlarmService1CallbackHandler(Object clientData){
    ...
    */
    public AlarmService1CallbackHandler(){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultgetNominalReliability(
                    soar.ws.fx.services.AL.AlarmService1Stub.GetNominalReliabilityResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultrun(
                    soar.ws.fx.services.AL.AlarmService1Stub.RunResponse result
                        ) {
           }
