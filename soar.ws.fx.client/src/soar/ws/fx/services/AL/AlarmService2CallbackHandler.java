...
/**
 * AlarmService2CallbackHandler.java
 *
 ...
 */
    ...
    /**
     *  AlarmService2CallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class AlarmService2CallbackHandler{
    ...
    */
    public AlarmService2CallbackHandler(Object clientData){
    ...
    */
    public AlarmService2CallbackHandler(){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultgetNominalReliability(
                    soar.ws.fx.services.AL.AlarmService2Stub.GetNominalReliabilityResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultrun(
                    soar.ws.fx.services.AL.AlarmService2Stub.RunResponse result
                        ) {
           }
