...
public class OrderService2ExceptionException extends java.lang.Exception{
    ...
    private soar.ws.fx.services.OR.OrderService2Stub.OrderService2Exception faultMessage;
    ...
    public void setFaultMessage(soar.ws.fx.services.OR.OrderService2Stub.OrderService2Exception msg){
       faultMessage = msg;
    }
    
    public soar.ws.fx.services.OR.OrderService2Stub.OrderService2Exception getFaultMessage(){
       return faultMessage;
    }
}
