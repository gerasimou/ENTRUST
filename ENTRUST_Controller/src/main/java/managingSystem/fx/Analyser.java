...
import managingSystem.fx.Knowledge.ServiceCharacteristics;
...
public class Analyser {
    ...
    public Analyser(){		
	    ...
	    this.NUM_OF_OPERATIONS		= ManagingSystemFX.NUM_OF_OPERATIONS;
	    this.NUM_OF_SERVICES		= ManagingSystemFX.NUM_OF_SERVICES;
