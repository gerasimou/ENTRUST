...
public class RQVResult{
	...
	public RQVResult (int CSC, double speed, double req1Result, double req2Result){
		...
		this.speed   	= (int) (speed * ManagingSystemUUV.MULTIPLIER);
		this.req1Result	= (int) (Math.round(req1Result * ManagingSystemUUV.MULTIPLIER));
		this.req2Result	= (int) (Math.round(req2Result * ManagingSystemUUV.MULTIPLIER));
	}
